...
<div class="container-fluid">
    <div class="row">
        ...
        {{-- Contenido principal --}}
        <div class="col-md-9">
            <h1>Agregar Progreso de Usuario</h1>
           ...
           <form action="{{ route('admin.progresousuario.store') }}" method="POST">
               @csrf
               ...
               <div class="mb-3">
                   ...
                   <select name="id_leccion_actual" id="id_leccion_actual" class="form-select" required>
               ...
               <div class="mb-3">
                   ...
                   <input type="number" name="ejercicios_completados" id="ejercicios_completados" class="form-control" min="0" required>
               </div>

               <button type="submit" class="btn btn-success">
                   <i class="bi bi-check-circle"></i> Guardar Progreso
               </button>
